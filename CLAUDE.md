...
- `docs/CHANGE_HISTORY.md` — persistent log of every change, organized by version. Append new entries here as work is completed.
- `docs/RELEASE_NOTES.md` — scratchpad for the next GitHub release only. After a release is published, wipe this file clean. To draft release notes, use `git log <last-tag>..HEAD` and `docs/CHANGE_HISTORY.md` to identify what changed since the last release.
